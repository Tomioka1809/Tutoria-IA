...
| `INC-003` | Documentación Embeddings | `03_pipeline_rag.md` menciona `text-embedding-004`. | `gemini_adapter.py` ejecuta `gemini-embedding-001`. | Inconsistencia en la documentación técnica formal. | Fase 3 |
...
| `HALL-CHAT-001` | Chatbot | `ChatUseCase` ejecuta directamente consultas SQL sobre modelos ORM de infraestructura para las herramientas del LLM. | Alta | Fase 2 |
