    ...
    <ParallaxScrollView
      ...
      <CollapsibleSection title="File-based routing">
        <ThemedText>
          ...
          <ThemedText type="defaultSemiBold">app/(estudiante)/index.tsx</ThemedText> and{' '}
          <ThemedText type="defaultSemiBold">app/(estudiante)/explore.tsx</ThemedText>
        </ThemedText>
        <ThemedText>
          The layout file in <ThemedText type="defaultSemiBold">app/(estudiante)/_layout.tsx</ThemedText>{' '}
